              ...
              <div className="grid md:grid-cols-2 gap-4">
                {Object.entries(projectTypes).map(([key, type]) => (
                  <label key={key} className="cursor-pointer">
                    <div
                      className={`p-4 border rounded-lg transition-all duration-200 hover:bg-gray-50 ${projectType === key
            ...
            <AccordionSection title="Дополнительные функции">
              <div className="grid md:grid-cols-2 gap-4">
                {Object.entries(additionalFeatures).map(([key, feature]) => (
                  <label key={key} className="cursor-pointer">
                    <div
                      className={`p-4 border rounded-lg transition-all duration-200 hover:bg-gray-50 ${features.includes(key)
                        ? "border-[#b76ec7] bg-[#b76ec7]/5"
                        : "border-gray-200"
                        }`}
                    >
            ...
            <AccordionSection title="Сроки выполнения">
              <div className="grid md:grid-cols-2 gap-4">
                {Object.entries(timelineMultipliers).map(([key, option]) => (
                  <label key={key} className="cursor-pointer">
                    <div
                      className={`p-4 border rounded-lg transition-all duration-200 hover:bg-gray-50 ${timeline === key
                        ? "border-[#b76ec7] bg-[#b76ec7]/5"
                        : "border-gray-200"
                        }`}
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 flex justify-between items-center">
                          ...
                          <span
                            className={`text-sm px-2 py-1 rounded ${option.multiplier > 1
            ...
            <div className="bg-gradient-to-r from-[#b76ec7]/10 to-[#b76ec7]/5 rounded-lg p-6 border border-[#b76ec7]/20">
              <div className="flex flex-col sm:flex-row items-center justify-between text-center gap-4">
                ...
                <div className="text-right">
                  <div className="text-3xl text-center font-bold text-[#b76ec7] mb-3">
