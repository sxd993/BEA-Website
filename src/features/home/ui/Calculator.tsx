...
export const Calculator = () => {
  ...
  return (
    <section className="py-8 md: py-10 bg-background border-b border-gray-200">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl border border-gray-300 shadow-lg p-4 md:p-8">
            <h3 className="text-xl md:text-2xl text-center font-semibold mb-6 md:mb-8">
            ...
            <div className="bg-gradient-to-r from-[#b76ec7]/10 to-[#b76ec7]/5 rounded-lg p-4 md:p-6 border border-[#b76ec7]/20">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="w-full space-y-4">
                  <div className="text-2xl md:text-3xl font-bold text-[#b76ec7]">
